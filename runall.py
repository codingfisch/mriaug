...
def save_image(t: torch.Tensor, filepath: str):
    nii = NiftiImage(arrays=t.numpy()[0, 0], affines=img.affine)
...
if __name__ == '__main__':
    ...
    save_image(mriaug.flip3d(x), 'data/flip.png')
    ...
    save_image(mriaug.affinewarp3d(x, translate, rotate, zoom, shear, magnitude=.02), 'data/affinewarp.png')
